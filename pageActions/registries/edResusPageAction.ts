...
export class EdResusPageAction {
    ...
    async populateTheEdResusTab(arrivalData: Arrival, initialAssessmentData: InitialAssessment, vitalsData: Vitals, alcoholData: Alcohol) {
        await this.edResusPage.clickOnTabFromNavbar('ED/Resus');
        ...
        await this.edResusPage.clickOnTabFromNavbar('Initial Assessment');
        ...
        await this.edResusPage.clickOnTabFromNavbar('Labs/Toxicology');
