...
export class InjuryPage extends RegistriesPage {
    ...
    async populateFieldOfECodesForm(eCodesData: MechanismOfInjury): Promise<void> {
        ...
        // await this.scrollAndSelectDropdownOption(this.secondaryICD10MechanismDropdown, this.optionOfSecondaryICD10MechanismDropdown(eCodesData.secondaryICD10Mechanism))
        // await this.scrollAndSelectDropdownOption(this.tertiaryICD10MechanismDropdown, this.optionOfTertiaryICD10MechanismDropdown(eCodesData.tertiaryICD10Mechanism))
